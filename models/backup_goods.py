...
# Average CV score on the training set was:0.6206336065595056
exported_pipeline = make_pipeline(
    StackingEstimator(estimator=ExtraTreesClassifier(bootstrap=False, criterion="entropy", max_features=0.45, min_samples_leaf=15, min_samples_split=11, n_estimators=100)),
    KNeighborsClassifier(n_neighbors=63, p=1, weights="distance")
)'''
